...
@EnableJpaRepositories({"com.atsistemas.concesionario.persistencia.data","com.atsistemas.concesionario.persistencia.security.data"}) //Dónde están las interfaces de Data
@ComponentScan({"com.atsistemas.concesionario.servicio.impl","com.atsistemas.concesionario.servicio.security.impl"}) //Dónde están los Beans de spring
